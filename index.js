...
// Tokeni burada belirtin
const token = 'MTIxNTc0MTM4MzgyNjk5NzMzMA.GHDNWS.c5rlFRVwJJYfQ4F2qWJMjCoOZh_KMtsIq5Mnfg';
...
client.once('ready', () => {
  ...
  client.user.setActivity(`${config.prefix}gen │ its_aa${config.servername}`, { type: "STREAMING", url: "https://twitch.tv/wtcn" }); // Set the bot's activity status
